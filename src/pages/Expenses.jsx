                        ...
                        <div className="flex items-start gap-2 min-w-0 flex-1">
                          ...
                          <div className="min-w-0">
                            <div className="flex flex-wrap items-center gap-1.5">
                              ...
                              {e.is_recurring &&
                          <span className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded-md border bg-violet-500/15 text-violet-500 border-violet-500/30 shrink-0">↻</span>
                          }
                            </div>
