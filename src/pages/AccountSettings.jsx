      ...
      <div className="bg-card rounded-xl border border-border p-5 space-y-4">
        ...
        <div className="space-y-3">
          <div>
            ...
            <Input value={user?.full_name || ""} disabled className="bg-muted/30" />
          </div>
          <div>
      ...
      <div className="bg-card rounded-xl border border-border p-5 space-y-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg border text-sm font-medium transition-all ${theme === "light" ? "border-primary bg-primary/10 text-primary" : "border-border hover:bg-muted"}`}
          >
            <Sun className="w-4 h-4" /> Light
          </button>
          <button
            onClick={() => applyTheme("dark")}
            className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg border text-sm font-medium transition-all ${theme === "dark" ? "border-primary bg-primary/10 text-primary" : "border-border hover:bg-muted"}`}
          >
